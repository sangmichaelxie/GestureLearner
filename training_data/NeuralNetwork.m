...
function NeuralNetwork
    ...
    temp_a = horzcat(ones(1, size(O, 1)), zeros(1, size(X, 1)), zeros(1, size(Z, 1)), zeros(1, size(V, 1)), zeros(1, size(W, 1)));
    temp_b = horzcat(zeros(1, size(O, 1)), ones(1, size(X, 1)), zeros(1, size(Z, 1)), zeros(1, size(V, 1)), zeros(1, size(W, 1)));
    temp_c = horzcat(zeros(1, size(O, 1)), zeros(1, size(X, 1)), ones(1, size(Z, 1)), zeros(1, size(V, 1)), zeros(1, size(W, 1)));
    temp_d = horzcat(zeros(1, size(O, 1)), zeros(1, size(X, 1)), zeros(1, size(Z, 1)), ones(1, size(V, 1)), zeros(1, size(W, 1)));
    temp_e = horzcat(zeros(1, size(O, 1)), zeros(1, size(X, 1)), zeros(1, size(Z, 1)), zeros(1, size(V, 1)), ones(1, size(W, 1)));
    training_label_vector = [temp_a; temp_b; temp_c; temp_d; temp_e;];
    ...
    net.divideParam.trainRatio = 50 / 155;
    net.divideParam.valRatio = 0 / 155;
    net.divideParam.testRatio = 105 / 155;
